...
import { aiExplainError } from "../ai/aiExplain.js";
...
// Off by default — the inline "after: italic red explanation" treatment
// is too loud against the native squiggle + Protege's CodeLens + error-
// line highlight. Users who want it back toggle it on via the webview's
// `feature/toggle` message (see webviewHost.ts). Struggle-chip CodeLens
// lives in struggleChip.ts and is unaffected by this flag.
